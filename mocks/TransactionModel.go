...
// GetReserByTrans provides a mock function with given fields: id
func (_m *TransactionModel) GetReserByTrans(id uint) (transaction.Transaction, error) {
	ret := _m.Called(id)

	if len(ret) == 0 {
		panic("no return value specified for GetReserByTrans")
	}
