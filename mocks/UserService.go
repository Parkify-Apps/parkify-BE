...
// DeleteAccount provides a mock function with given fields: token
func (_m *UserService) DeleteAccount(token *jwt.Token) error {
	ret := _m.Called(token)
...
// UpdateProfile provides a mock function with given fields: token, newData
func (_m *UserService) UpdateProfile(token *jwt.Token, newData user.User) error {
